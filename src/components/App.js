...
function App() {
  return (
    <div className="App">
      ...
      <Line />
      <hr />
      <h4 className="number">2) Choose your Station. <TipButton message="Add some stuff"/></h4>
      <StationSearchbar />
      <hr />
      <h4 className="number">3) Choose your direction of travel. <TipButton message="Carole Baskin did it"/></h4>
      <DirectionSelection />
      <hr />
      <hr />
